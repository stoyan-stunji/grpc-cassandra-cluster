...
class ClusterServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetClusterInfo = channel.unary_unary(
                ...
                request_serializer=cluster__pb2.ClusterRequest.SerializeToString,
                response_deserializer=cluster__pb2.ClusterResponse.FromString,
...
def add_ClusterServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetClusterInfo': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=cluster__pb2.ClusterRequest.FromString,
                    response_serializer=cluster__pb2.ClusterResponse.SerializeToString,
            ),
    }
...
class ClusterService(object):
    ...
    def GetClusterInfo(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/cluster.ClusterService/GetClusterInfo',
            cluster__pb2.ClusterRequest.SerializeToString,
            cluster__pb2.ClusterResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
