...
public class CompressionDictionaryCommandGroup
{
    ...
    public static class TrainDictionary extends AbstractCommand
    {
        ...
        @Option(names = {"--max-dict-size"}, description = "Maximum size of a trained compression dictionary. " +
        ...
        @Option(names = "--max-total-sample-size", description = "Maximum total size of sample data to collect for dictionary training. " +
        ...
        private static void validateParameters(PrintStream err, String trainingMaxDictionarySize, String trainingMaxTotalSampleSize)
        {
            if (trainingMaxDictionarySize != null)
            {
                ...
                {
                    err.println("Invalid value for --max-dict-size: " + t.getMessage());
                    System.exit(1);
                }
            }
            ...
            if (trainingMaxTotalSampleSize != null)
            {
                ...
                {
                    err.println("Invalid value for --max-total-sample-size: " + t.getMessage());
                    System.exit(1);
                }
            }
        }
